...
class REGREGDtELFOpcode(object):
    ...
    def __init__(self, annotations_file, who_fea_file, dtanno_file):
        ...
        self.fea_csv = "../../Features/ELFOpocode/SamSpa/ELFOpocode"+self.dtanno_file[0:-5]+".xlsx"
        ...
        with pd.ExcelWriter(self.fea_csv, engine='xlsxwriter') as writer:
            ...
            for train_year in self.year_list:
                ...
                for train_arch in self.arch_list:
                    ...
                    test_result_df_1 = test_result_df_1.rename(columns={'arch': 'arch_identifies'})                  
                    ...
                    test_result_df_2 = test_result_df_2.rename(columns={'arch': 'arch_identifies'})                  
