...
class REGDtELFEntry(object):
    ...
    def __init__(self, annotations_file, who_fea_file, dtanno_file):
        ...
        self.fea_csv = "../../Features/ELFEntry/DiffSpa/ELFEntry"+self.dtanno_file[0:-5]+".xlsx"
        self.fea_filter = "../../Features/ELFEntry/DiffSpa/FeaELFEntry"+self.dtanno_file[0:-5]+".txt"
