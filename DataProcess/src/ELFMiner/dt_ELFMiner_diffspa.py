...
class REGDtELFMiner(object):
    ...
    def __init__(self, annotations_file, who_fea_file, dtanno_file):
        ...
        self.fea_csv = "../../Features/ELFMiner/DiffSpa/ELFMiner"+self.dtanno_file[0:-5]+".xlsx"
        self.fea_filter = "../../Features/ELFMiner/DiffSpa/FeaELFMiner"+self.dtanno_file[0:-5]+".txt"
