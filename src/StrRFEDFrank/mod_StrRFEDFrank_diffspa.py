...
def optimal_results(dtanno_file):
    fea_filter = "../../Features/StrRFEDFrank/DiffSpa/StrRFEDFrank"+dtanno_file[0:-5]+".xlsx"
    ...
    for train_year, train_arch in itertools.product(year_list, train_arch_list):
        ...
        print(f"{sheetname}:")
        sheetname_best_model_dir = "../../Results/BestModels/StrRFEDFrank/StrRFEDFrank"+dtanno_file[0:-5]+"/"+sheetname
    ...
    result_path = "../../Results/DiffSpa/StrRFEDFrank/StrRFEDFrank"+dtanno_file[0:-5]+".txt"
    with open(result_path, 'w') as f:
        json.dump(whofol_results, f, indent=4)     
    
    train_result_path = "../../Results/DiffSpa/StrRFEDFrank/StrRFEDFrank"+dtanno_file[0:-5]+"_train.txt"
    with open(train_result_path, 'w') as f:
        json.dump(train_results, f, indent=4)     
        
    spa_result_path = "../../Results/DiffSpa/SpaResults/StrRFEDFrank/StrRFEDFrank"+dtanno_file[0:-5]+".txt" 
    with open(spa_result_path, 'w') as f:
        json.dump(spa_whofol_results, f, indent=4)    
    
    spa_train_result_path = "../../Results/DiffSpa/SpaResults/StrRFEDFrank/StrRFEDFrank"+dtanno_file[0:-5]+"_train.txt" 
