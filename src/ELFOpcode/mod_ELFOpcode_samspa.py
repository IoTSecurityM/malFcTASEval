...
def optimal_results(dtanno_file):
    fea_filter = "../../Features/ELFOpocode/SamSpa/ELFOpocode"+dtanno_file[0:-5]+".xlsx" 
    ...
    for train_year, train_arch in itertools.product(year_list, train_arch_list):
        ...
        for name in model_name_list:
            # Train the model
            with open("../../Results/BestModels/ELFOpocode/ELFOpocode"+dtanno_file[0:-5]+"/"+sheetname+f'/best_{name}.pkl', 'rb') as f:
    ...
    result_path = "../../Results/SamSpa/ELFOpocode/ELFOpocode"+dtanno_file[0:-5]+".txt" 
    with open(result_path, 'w') as f:
        json.dump(whofol_results, f, indent=4)     
    
    train_result_path = "../../Results/SamSpa/ELFOpocode/ELFOpocode"+dtanno_file[0:-5]+"_train.txt" 
    with open(train_result_path, 'w') as f:
        json.dump(train_results, f, indent=4)     
        
    spa_result_path = "../../Results/SamSpa/SpaResults/ELFOpocode/ELFOpocode"+dtanno_file[0:-5]+".txt"
    with open(spa_result_path, 'w') as f:
        json.dump(spa_whofol_results, f, indent=4)    
    
    spa_train_result_path = "../../Results/SamSpa/SpaResults/ELFOpocode/ELFOpocode"+dtanno_file[0:-5]+"_train.txt" 
