...
def optimal_results(dtanno_file):
    fea_filter = "../../Features/ELFEntry/DiffSpa/ELFEntry"+dtanno_file[0:-5]+".xlsx" 
    fea_names_path = "../../Features/ELFEntry/DiffSpa/FeaELFEntry"+dtanno_file[0:-5]+".txt"
    ...
    for train_year, train_arch in itertools.product(year_list, train_arch_list):
        ...
        print(f"{sheetname}:")
        sheetname_best_model_dir = "../../Results/BestModels/ELFEntry/ELFEntry"+dtanno_file[0:-5]+"/"+sheetname
    ...
    result_path = "../../Results/DiffSpa/ELFEntry/ELFEntry"+dtanno_file[0:-5]+".txt" 
    with open(result_path, 'w') as f:
        json.dump(whofol_results, f, indent=4)     
    
    train_result_path = "../../Results/DiffSpa/ELFEntry/ELFEntry"+dtanno_file[0:-5]+"_train.txt" 
    with open(train_result_path, 'w') as f:
        json.dump(train_results, f, indent=4)     
        
    spa_result_path = "../../Results/DiffSpa/SpaResults/ELFEntry/ELFEntry"+dtanno_file[0:-5]+".txt" 
    with open(spa_result_path, 'w') as f:
        json.dump(spa_whofol_results, f, indent=4)    
    
    spa_train_result_path = "../../Results/DiffSpa/SpaResults/ELFEntry/ELFEntry"+dtanno_file[0:-5]+"_train.txt" 
