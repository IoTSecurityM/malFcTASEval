...
def optimal_results(dtanno_file):
    ...
    for train_year, train_arch in itertools.product(year_list, train_arch_list):
        ...
        for name in model_name_list:
            ...
            with open("../../Results/BestModels/ELFMiner/ELFMiner"+dtanno_file[0:-5]+"/"+sheetname+f'/best_{name}.pkl', 'rb') as f:
    ...
    result_path = "../../Results/SamSpa/ELFMiner/ELFMiner"+dtanno_file[0:-5]+".txt"  
    with open(result_path, 'w') as f:
        json.dump(whofol_results, f, indent=4)     
    
    train_result_path = "../../Results/SamSpa/ELFMiner/ELFMiner"+dtanno_file[0:-5]+"_train.txt"
    with open(train_result_path, 'w') as f:
        json.dump(train_results, f, indent=4)     
        
    spa_result_path = "../../Results/SamSpa/SpaResults/ELFMiner/ELFMiner"+dtanno_file[0:-5]+".txt" 
    with open(spa_result_path, 'w') as f:
        json.dump(spa_whofol_results, f, indent=4)    
    
    spa_train_result_path = "../../Results/SamSpa/SpaResults/ELFMiner/ELFMiner"+dtanno_file[0:-5]+"_train.txt" 
